        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
          <div>
            ...
            <p className="text-brown text-lg mb-6">
              ...
              in finance, investing, and making a positive impact. Our
              recruitment process is designed to identify motivated individuals
          ...
          <div className="space-y-8">
            ...
            {steps.map((step, index) => (
              <div key={index} className="flex">
                ...
                <div>
                  <h3 className="text-brown text-xl font-medium">
                    {step.title}
                  </h3>
             ...
             <a href="/join#form"><button className="p-4 bg-brown mt-6 ml-12">Join us now</button></a>
          </div>
