export default function Why() {
    return (
     <section className="py-12 px-6 md:px-12 min-h-screen flex items-end justify-center gap-36">
        <div className="flex flex-col gap-12 leading-[150%] w-1/3">
          <h2
        ...
        <div className="w-1/3 h-screen relative">
          <img
            ...
            className="shadow-lg w-2/3 h-[70vh] object-cover absolute top-20 -left-20"
          />
          <div className="w-2/3 h-[60vh] shadow-lg bg-brown absolute bottom-0 right-20 p-8 font-thin text-sm gap-4 flex flex-col">
