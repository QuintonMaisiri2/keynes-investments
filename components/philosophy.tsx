  ...
  return (
    <section className="px-6 md:px-12 min-h-screen">
      <div className="md:max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-end min-h-screen">
          <div className="flex flex-col gap-12">
            ...
            <p className="text-brown text-lg ">
              At Keynes Investments, We take a long-term, fundamentals-based
              approach to investing. Our goal is to generate value with purpose.
              Our investment philosophy is built on four key pillars:
            </p>
            <a href="/join#form">
          ...
          <div className="lg:w-2/3 relative lg:h-full h-max">
